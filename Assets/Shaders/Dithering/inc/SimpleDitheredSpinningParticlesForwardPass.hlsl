...
CustomV2f ParticlesLitVertex(CustomVertInput input)
{
    ...
    VertexNormalInputs normalInput = GetVertexNormalInputs(normal, float4(tangent, input.tangentOS.w));
