...
// No shadow
// No distortion
Shader "DistanceDither/Particles/Facing Particle"
{
    Properties
    {
        ...
        _FadeDistanceOffset("Fade Distance Offset", Float) = 1.0

        _xAxisFollowFactor("the x axis follow factor", Float) = 1.0

        _DitherIntensity("Dither Intensity", Float) = 1.0
        _DitherScale("Dither Scale", Float) = 1.0

        _LambertDotOverride("Lambert dot override", Float) = 1.0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "SimpleDitheredFacingParticlesForwardPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #pragma shader_feature_local_fragment _ALPHATEST_ON
            #pragma shader_feature_local_fragment _GLOSSINESS_FROM_BASE_ALPHA
            #pragma shader_feature _DITHERED_SHADOWS
            ...
            #ifdef _DITHERED_SHADOWS
                #include "../../inc/ShadowCasterPassParticlesDithered.hlsl"
            #else 
    ...
    CustomEditor "UnityEditor.Rendering.Universal.ShaderGUI.ParticlesFacingDitheredShader"
}
