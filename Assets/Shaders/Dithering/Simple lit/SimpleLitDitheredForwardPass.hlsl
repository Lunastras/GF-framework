...
inline void InitializeSimpleLitSurfaceDataDither(float2 uv, out SurfaceData outSurfaceData, float2 screencoords, float distance, float ditherIntensity, float ditherScale)
{
    ...
    ApplyDistanceDither_float(ditherIntensity, ditherScale, screencoords, distance, _StartFadeDistance, _Cutoff, albedoAlpha);
...
half4 LitPassFragmentSimple(Varyings input) : SV_Target
{
    ...
    InitializeSimpleLitSurfaceDataDither(input.uv, surfaceData, screenpos, dst, _DitherIntensity, _DitherScale); 
