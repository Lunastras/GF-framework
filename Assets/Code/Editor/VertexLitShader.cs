...
{
    internal class VertexLitShader : BaseShaderGUI
    {
        static readonly string[] workflowModeNames = Enum.GetNames(typeof(LitGUI.WorkflowMode));

        private LitGUI.LitProperties litProperties;
        private VertexLitDetailGUI.LitProperties litDetailProperties;

        const string SPECULAR_BOOST = "_SpecularBoost";
        const string GRAZING_BOOST = "_GrazingBoost";

        /*
        public override void FillAdditionalFoldouts(MaterialHeaderScopeList materialScopesList)
        {
            materialScopesList.RegisterHeaderScope(VertexLitDetailGUI.Styles.detailInputs, Expandable.Details, _ => VertexLitDetailGUI.DoDetailArea(litDetailProperties, materialEditor));
        }*/
        ...
        public override void FindProperties(MaterialProperty[] properties)
        {
            ...
            litDetailProperties = new VertexLitDetailGUI.LitProperties(properties);
        }

        // material changed check
        public override void ValidateMaterial(Material material)
        {
            SetMaterialKeywords(material, LitGUI.SetMaterialKeywords, VertexLitDetailGUI.SetMaterialKeywords);
        }
        ...
        public override void DrawSurfaceOptions(Material material)
        {
            ...
            float specularBoost = material.GetFloat(SPECULAR_BOOST);
            float grazingBoost = material.GetFloat(GRAZING_BOOST);

            specularBoost = EditorGUILayout.Slider("Specular Boost", specularBoost, 0, 20);
            grazingBoost = EditorGUILayout.Slider("Grazing Boost", grazingBoost, 0, 20);

            if (EditorGUI.EndChangeCheck())
            {
                material.SetFloat(SPECULAR_BOOST, specularBoost);
                material.SetFloat(GRAZING_BOOST, grazingBoost);
            }
        }
    ...
    internal class VertexLitDetailGUI
    {
