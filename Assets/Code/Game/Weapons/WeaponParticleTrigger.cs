...
public class WeaponParticleTrigger : WeaponParticle
{
    ...
    protected void CollisionBehaviour(ref ParticleSystem.Particle particle, GameObject hitObject)
    {
        ...
        if (damageSource)
        {
            GfgStatsCharacter selfStats = damageSource.GetGfgStatsCharacter();
            GfgStatsCharacter collisionStats = hitObject.GetComponent<GfgStatsCharacter>();
    ...
    protected virtual void HitTarget(ref ParticleSystem.Particle particle, GfgStatsCharacter self, GfgStatsCharacter target, float damageMultiplier, DamageSource damageSource)
    {
    ...
    protected virtual void HitCollision(ref ParticleSystem.Particle particle, GfgStatsCharacter self, GameObject hitObject, DamageSource damageSource)
    {
