...
public abstract class WeaponParticle : WeaponGeneric
{
    ...
    protected void Awake()
    {
        ...
        if (GetGfgStatsCharacter() == null)
            SetStatsCharacter(GetComponent<GfgStatsCharacter>());
    ...
    protected void OnOwnerKilled(GfgStatsCharacter character, DamageData aDamageData)
    {
    ...
    {
        base.WasSwitchedOn();
        var GfgStatsCharacter = GetGfgStatsCharacter();
        if (GfgStatsCharacter)
            GfgStatsCharacter.OnKilledUnique += OnOwnerKilled;
    }
