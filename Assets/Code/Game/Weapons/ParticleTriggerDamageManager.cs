...
public class ParticleTriggerDamageManager : MonoBehaviour
{
    ...
    public static void AddCharacter(GfgStatsCharacter obj)
    {
    ...
    public static void RemoveCharacter(GfgStatsCharacter characterToRemove)
    {
        int indexToRemove = characterToRemove.GetCharacterIndex(CharacterIndexType.CHARACTERS_ALL_LIST);
        int numParticleWeapons = ParticleWeapons.Count;
        int lastIndex = GfgManagerCharacters.GetAllCharactersCount() - 1;
        GfgStatsCharacter lastCharacter = GfgManagerCharacters.GetAllCharacters()[lastIndex];
    ...
    public static int AddParticleSystem(WeaponParticle weapon)
    {
        ...
        var characters = GfgManagerCharacters.GetAllCharacters();
