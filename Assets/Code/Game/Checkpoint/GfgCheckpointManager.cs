...
public class GfgCheckpointManager : MonoBehaviour
{
    ...
    [SerializeField] private GfgStatsCharacter m_statsCharacter = null;
    ...
    public void SetCheckpoint(GfTriggerCheckpoint checkpoint)
    {
        ...
        GfgManagerLevel.OnCheckpointSet(this, !checkpoint.SoftCheckpoint);
    }
    ...
    public void ResetToSoftCheckpoint(float damage = 0, bool canKill = false)
    {
        if (!m_isSoftReseting)
        {
            ...
            float delay = GfgManagerLevel.OnCheckpointReset(this, false);
    ...
    protected void ExecuteCheckpointStates()
    {
        ...
        GfgManagerLevel.CheckpointStatesExecuted(this);
    }
