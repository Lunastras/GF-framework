...
public class GfgMovementAnimator : MonoBehaviour
{
    [SerializeField]
    ...
    [SerializeField]
    protected GfgSpriteAnimator3D m_spriteAnimator;
    ...
    void Start()
    {
        ...
        if (null == m_spriteAnimator) m_spriteAnimator = GetComponent<GfgSpriteAnimator3D>();
    }
