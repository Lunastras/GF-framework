...
public class ParticleHomingPositionSetter : MonoBehaviour
{
    ...
    void OnJobSchedule()
    {
        ...
        {
            m_particleHomingSystem.SetTargetPositions(GfgManagerCharacters.GetAllCharacterPositions());
        }
        else
        {
            m_particleHomingSystem.SetTargetPositions(GfgManagerCharacters.GetCharacterPositions(m_characterTypeToHomeOn));
        }
    }
}
