...
Shader "DistanceDither/Particles/Spinning Particle"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "SimpleDitheredSpinningParticlesForwardPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "ShadowCasterPassSpinningParticlesDithering.hlsl"
            ENDHLSL
        }
    ...
    CustomEditor "UnityEditor.Rendering.Universal.ShaderGUI.ParticlesSpinningDitheredShader"
}
