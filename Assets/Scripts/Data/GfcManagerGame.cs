...
public class GfcManagerGame : MonoBehaviour
{
    ...
    public static bool GameInitialised
    {
        get
        {
            return GfManagerServer.HasInstance;
        }
    }
    ...
    protected void OnServerStoppedFunc(bool noIdea)
    {
        ...
        GfManagerServer.DestroyInstance();
        QuitToMenu();
    }
    ...
    {
        GfManagerLevel.Instance.CanPause = false;
        if (GfManagerLevel.IsPaused())
            GfManagerLevel.PauseToggle();
    ...
    public static void SetTimeScale(float timeScale)
    {
        ...
        if (!GfManagerLevel.IsPaused() || IsMultiplayer) Time.timeScale = timeScale;
    }
}
