...
public class GfcManagerCharacters : MonoBehaviour
{
    protected List<StatsCharacter>[] m_instantiatedCharacters;
    protected static GfcManagerCharacters Instance = null;
    ...
    public static void EraseAllEnemyBullets(StatsCharacter characterResponsible, float3 centerOfErase, float speedFromCenter, float eraseRadius)
    {
        ...
        {
            if (GfcManagerCharacters.EnemyWith(characterResponsible.GetCharacterType(), (CharacterTypes)i))
            {
                GfcManagerCharacters.EraseAllBullets((CharacterTypes)i, characterResponsible, centerOfErase, speedFromCenter, eraseRadius);
            }
        }
    }
