...
public class GfgManagerWeapons : MonoBehaviour
{
    [SerializeField]
    public WeaponTier[] m_weaponTiers;

    private static GfgManagerWeapons Instance = null;
...
public struct WeaponOwnedData : INetworkSerializable
{
    ...
    public string GetEffectiveName() { return NameOverride != null && NameOverride.Length > 0 ? NameOverride : GfgManagerWeapons.GetWeaponName(WeaponData); }

    public string GetEffectiveDescription() { return DescriptionOverride != null && DescriptionOverride.Length > 0 ? DescriptionOverride : GfgManagerWeapons.GetWeaponDescription(WeaponData); }
    ...
    public readonly Color TierColor { get { return GfgManagerWeapons.GetTierColor(Tier); } }

    public readonly Color TierColorComplementary { get { return GfgManagerWeapons.GetTierColorComplementary(Tier); } }
