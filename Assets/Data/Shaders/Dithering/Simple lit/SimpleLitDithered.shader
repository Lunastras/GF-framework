...
Shader "DistanceDither/Simple Lit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "SimpleLitDitheredForwardPass.hlsl"
        ...
        Pass
        {
            ...
            #include "Packages/com.unity.render-pipelines.universal/Shaders/SimpleLitInput.hlsl"
                ...
                #include "../inc/ShadowCasterPassDithered.hlsl"
            #else 
        ...
        Pass
        {
            ...
            //#include "../inc/DepthOnlyPassDither.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "../inc/SimpleLitDepthNormalsPassDither.hlsl"
            ENDHLSL
        }
